Contributing to Easy_OCT
===============================

There are many ways to contribute to Easy_OCT.

  * Submit a feature request or bug, or add to the discussion on the [Easy_OCT issue tracker][is]
  * Submit a [Pull Request][pr] to improve Easy_OCT.
...
If you are new to Easy_OCT development and you don't have push access to the Easy_OCT
...
When submitting a PR, make sure to add a `Cc: @Easy_OCT/developers` comment to
notify Easy_OCT developers of your awesome contributions. Based on the
...
* You do NOT have push access: A Easy_OCT core developer will integrate your PR.
...
[pr]: https://github.com/HNU/Easy_OCT/merge_requests
[is]: https://github.com/HNU/Easy_OCT/issues
